...
// Definición de los tipos para las props de PricingCard
interface PricingCardProps {
    ...
    subscription: string;
    buttonText: string;
    active?: boolean; // `active` es opcional
}

// Componente PricingCard con tipos
const PricingCard: React.FC<PricingCardProps> = ({
    ...
    return (
        <div className="min-h-screen w-full px-20 md:w-1/2 flex flex-col justify-center items-center">
...
// Definición de los tipos para las props de List
interface ListProps {
    children: React.ReactNode;
}

// Componente List con tipos
const List: React.FC<ListProps> = ({ children }) => {
    return <p className="text-base text-body-color dark:text-dark-6">{children}</p>;
};

// Componente Pricing (el componente principal) sin cambios significativos
const Pricing: React.FC = () => {
    return (
        <section className="welcome relative z-10 overflow-hidden bg-white pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
            <div className="container mx-auto">
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4">
                        <div className="mx-auto mb-[60px] max-w-[510px] text-center text-pink-50">
